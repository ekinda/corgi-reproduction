...
def main():
    bw_dir = REPO_ROOT / "data" / "figure2" / "cross_cell_tta"
    exon_bed = REPO_ROOT / "data" / "figure2" / "exons_trainingfolds_subset.bed"
    outdir = REPO_ROOT / "data" / "figure2" / "gene_level_cross_celltype"
